...
public class Timeline {
    ...
    public List<Status> getPublicTimeline() throws WeiboException {
        ...
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/public_timeline.json"));
    }
    ...
    public List<Status> getFriendsTimeline() throws WeiboException {
        ...
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/friends_timeline.json"));
    ...
    public List<Status> getHomeTimeline() throws WeiboException {
        ...
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/home_timeline.json"));
    ...
    public List<Status> getUserTimeline(String access_token)
            throws WeiboException {
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/user_timeline.json"));
    }
    ...
    public List<Status> getRepostByMe() throws WeiboException {
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/repost_by_me.json"));
    }
    ...
    public List<Status> getMentions() throws WeiboException {
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/mentions.json"));
    }
    ...
    public List<Status> getRepostDaily() throws WeiboException {
        return Status.constructStatuses(Weibo.client.get(WeiboConfig.getValue("baseURL") + "statuses/hot/repost_daily.json"));
    }
    ...
    public List<Emotion> getEmotions() throws WeiboException {
        return Emotion.constructEmotions(Weibo.client.get(WeiboConfig.getValue("baseURL") + "emotions.json"));
    }
